...
/**
 * Linked list for storing nodes popped from stack. 
 * Mainly used for memory management.
 * structure of the code below was originally written by Alistar Moffat
 * Adapted by Huang Fu Sheng 
*/

list_t* make_empty_list(void);
void free_list(list_t *list);
list_t* insert_at_foot(list_t *list, void* left) ;

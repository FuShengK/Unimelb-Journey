...
public class Robot {
     ...
     * @param chargeDisplay To know if to show the charge information
     */
    public Robot(IMailDelivery delivery, MailPool mailPool, int number, boolean chargeDisplay) {
        this.id = "R" + number;
        ...
        this.charge = chargeDisplay;
        this.goingToDes = 0;
    }

    /**
     * This is called when a robot is assigned the mail items and ready to dispatch
     * for the delivery
     */
    ...
    public void operate() throws ExcessiveDeliveryException {
        ...
        case DELIVERING:
            if (current_floor == destination_floor) { // If already here drop off either way
                ...
                deliveryItem.countMovement(goingToDes); // to send the count of movements to mailitem
                goingToDes = 0; // reset the count of forwards to destination
                delivery.deliver(deliveryItem, charge);
                deliveryItem = null;
                deliveryCounter++;
